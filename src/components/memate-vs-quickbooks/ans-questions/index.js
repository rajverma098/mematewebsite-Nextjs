...
const QuestionAnswer = () => {
  ...
  const questions = [
    {
      question: "Why choose MeMate instead of QuickBooks?",
      key: 1,
      answer:
        "QuickBooks is made for professional project planners — not business owners running teams, jobs, and clients day to day. MeMate includes quoting, invoicing, time tracking, and CRM, all in one system, without the complexity or high licensing costs.",
    },
    {
      question: "Can MeMate replace QuickBooks for job tracking?",
      key: 2,
      answer:
    ...
    },
    {
      ...
      key: 4,
      answer:
        "MeMate uses a simplified job scheduling board, calendar views, and task flows — built for getting things done. For full Gantt-style planning, QuickBooks is better suited — but often overkill for most SMEs.",
    },
    {
      question: "Is MeMate cheaper than QuickBooks?",
      key: 5,
      answer:
    ...
    {
      question: "How easy is it to switch from QuickBooks to MeMate?",
      key: 7,
      answer:
