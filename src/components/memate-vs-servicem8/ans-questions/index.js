...
const QuestionAnswer = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer:
        "meMate features for job scheduling, invoicing, and tracking make it a better fit for automotive workshops than ServiceM8.",
      key: 18,
    },
    {
      question: "Which software has better Australian-based customer support, meMate or ServiceM8?",
      answer:
        "Both meMate and ServiceM8 offer Australian-based support, but meMate team specialises in broader business solutions.",
      key: 19,
    },
    {
      question: "Is meMate or ServiceM8 more user-friendly for Australian businesses?",
      answer:
        "meMate intuitive design caters to various industries, while ServiceM8 is optimised for field service businesses, making usability dependent on business type.",
      key: 20,
    },
  ];
