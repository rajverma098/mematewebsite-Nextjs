...
const SalesComponent = () => {
  ...
  <>
    ...
    data-aos-anchor-placement="top-bottom">
       ...
       <h1 className="comapirMainH1">MeMate vs Microsoft Project</h1>
      <div className="sales-componet-content-wrapper client-component-para">
        ...
        <div className="compaireHeadPara">
          <h2>Work Smarter with the #1 Microsoft Project Alternative <br/>
for Australian Business Owners</h2>
          <p>Microsoft Project is built for professional planners. MeMate is built for everyday Australian business owners who need to quote, schedule, assign, and track jobs — not just build timelines.</p>
        <br></br>
