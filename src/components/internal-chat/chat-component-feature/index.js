  ...
  return (
    ...
    >
      ...
      <div className="scroll-stack-wrapper">
        <ScrollStack CardDataComponent={ChatManagement} color="white" i={1} />
        <ScrollStack CardDataComponent={CRMChatTools} color="white" i={2} />
        <ScrollStack CardDataComponent={PipeLineTool} color="white" i={3} />
        <ScrollStack CardDataComponent={ChatProcessOptimiation} color="white" i={4} />
