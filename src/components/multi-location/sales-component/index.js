...
const SalesComponent = () => {
  ...
  <>
    ...
    >
       ...
       >
        Multi-Location Management Software for Growing Businesses
       </motion.h1>
       <div className="sales-headingF gradientText">Multi-Location <br></br> Management</div>
